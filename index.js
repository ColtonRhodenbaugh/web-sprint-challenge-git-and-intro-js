...
console.log('task 6:', addArtist(artists,'Colton', '2002-2022', 'Web design', 'Caucasian', 'I love my dogs. I also love going to Sox games!'));
...
🌟 EXAMPLE: Invoking artistInfo(artists, 'console.log('task 8:', artistInfo(artists, ""));) will return: 
